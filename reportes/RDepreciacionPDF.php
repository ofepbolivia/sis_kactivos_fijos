...
class RDepreciacionPDF extends  ReportePDF{
    ...
    function Header() {
        ...
        $descUbicacion = $this->objParam->getParametro('desc_ubicacion');
		switch ($descnom) {
        ...
        //segunda linea
        $this->Cell($swd1,3,'NUM','TBRL',0,'C');
        $this->Cell($swd2,3,'CODIGO','TBRL',0,'C');
        $this->Cell($swd3,3,$desno,'BTRL',0,'C');
        ...
        if ($descUbicacion == "si") {
         $this->Cell(18,3,'UBICACION','TBRL',0,'C');
        }
    ...
    function  generarReporte()
    {
        ...
        if($descUbicacion == "si") {
            $this->tablewidths=array(8,16,35,15,18,18,20,20,11,11,17,17,17,17,19,18);
            $this->tablealigns=array('C','L','L','C','R','R','R','R','R','R','R','R','R','R','R','C');        
        ...
        foreach($this->datos as $record){
            ...
            if($record['tipo'] == 'clasif') {
                ...
                $this->tableborders=array('LB','B','B','B','BLR','BLR','BLR','BLR','B','B','BLR','BLR','BLR','BLR','BRL','BLR');
                $this->tablenumbers=array(0,0,0,0,2,2,2,2,0,0,2,2,2,2,2,0);
                $RowArray = array(
                    's0'  => '',
                    's1' => $record['codigo'],
                ...
                $this->tableborders=array('LB','BLR','BLR','BLR','BLR','BLR','BLR','BLR','BLR','BLR','BLR','BLR','BLR','BLR','RBL', 'RBL');
                $this->tablenumbers=array(0,0,0,0,2,2,2,2,0,0,2,2,2,2,2,0);
                ...
                $this->tableborders=array('LB','B','B','B','BLR','BLR','BLR','BLR','B','B','BLR','BLR','BLR','BLR','RBL','RBL');
                $this->tablenumbers=array(0,0,0,0,2,2,2,2,0,0,2,2,2,2,2,0);
                $this->SetFont('','B',6);
                $this->SetFillColor(224, 235, 255);
