...
class RDepreciacionActulizadoPDF extends  ReportePDF{
    ...
    function Header() {
        ...
        $this->MultiCell(25,$y, $desno, 1,'C',false,0,'','',true,0,false,true,0,'T',false);
        ...
        $this->MultiCell(10,$y, 'DEP ACUM GEST ANT', 1,'C',false,0,'','',true,0,false,true,0,'T',false);
        $this->MultiCell(10,$y, 'ACT ACUM GEST ANT', 1,'C',false,0,'','',true,0,false,true,0,'T',false);
        $this->MultiCell(10,$y, 'DEP GESTION', 1,'C',false,0,'','',true,0,false,true,0,'T',false);
        $this->MultiCell(10,$y, 'DEP DEL PERIODO', 1,'C',false,0,'','',true,0,false,true,0,'T',false);
        $this->MultiCell(10,$y, 'DEP ACUM', 1,'C',false,0,'','',true,0,false,true,0,'T',false);
        $this->MultiCell(12,$y, 'VAL RESI', 1,'C',false,0,'','',true,0,false,true,0,'T',false);  		
    ...
    function  generarReporte()
    {
        ...
        $this->tablewidths=array(8,13,25,15,12,12,10,10,13,11,11,12,11,12,12,12,8,8,10,10,10,10,10,12);
        $this->tablealigns=array('C','L','L','C','R','R','R','R','R','R','R','R','R','R','R','R','R','R','R','R','R','R','R','R');
