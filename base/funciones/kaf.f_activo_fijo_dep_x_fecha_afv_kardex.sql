CREATE OR REPLACE FUNCTION kaf.f_activo_fijo_dep_x_fecha_afv_kardex(
...
BEGIN
  ...
  return query
    ...
    left join kaf.f_activo_fijo_dep_x_fecha_kardex(p_fecha,p_solo_finalizados,p_id_activo_f) adep
    on adep.id_activo_fijo_valor = afv.id_activo_fijo_valor
  where (afv.fecha_fin is null or afv.fecha_fin > p_fecha)
  and afv.fecha_inicio <= p_fecha and afv.id_moneda = 1 and afv.id_activo_fijo = p_id_activo_f;
