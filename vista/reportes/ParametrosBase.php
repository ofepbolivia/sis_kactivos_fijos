...
<script>
    Ext.define('Phx.vista.ParametrosBase', {
        ...
        constructor: function(config){
            ...
            //Eventos
            var date = new Date();
            this.cmbResponsable.store.baseParams.fecha = this.cmbResponsable.store.baseParams.fecha == 'sin_fecha'?'':date.dateFormat('d/m/Y');
        },
        createComponents: function(){
            ...
            this.cmbResponsable = new Ext.form.ComboBox({
                ...
                store: new Ext.data.JsonStore({
                    ...
                    remoteSort: true,
                    baseParams: {par_filtro:'desc_funcionario1#email_empresa#codigo#nombre_cargo', fecha:'sin_fecha'}
