...
Phx.vista.MovimientoAf=Ext.extend(Phx.gridInterfaz,{
		...
		},
		{
			config: {
				...
				store: new Ext.data.JsonStore({
					...
					totalProperty: 'total',
					fields: ['id_activo_fijo_valor', 'codigo','monto_inicio_dep'],
					remoteSort: true,
					baseParams: {par_filtro: 'actval.codigo'}
				}),
	...
	onReloadPage : function(m) {
		...
		if(this.maestro.cod_movimiento=='alta'){
			...
			Ext.apply(this.Cmp.id_activo_fijo.store.baseParams,{estado_mov:'alta',en_deposito_mov:'si',id_depto_mov: this.maestro.id_depto});
