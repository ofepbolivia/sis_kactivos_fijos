...
Phx.vista.Anexo=Ext.extend(Phx.gridInterfaz,{
	...
	//	console.log('LLEGA:',);
		...
		this.init();
		var that = this;
	  this.store.baseParams.an4 = that.an4;
		...
		this.addButton('btn_reporte4',
				{
				//grupo: [0],
				text: 'Reporte Anexo 4',
				iconCls: 'bexcel',
				disabled: false,
				handler: this.onButtonReporte4,
				tooltip: '<b>Reporte Anexo 4</b><br/>Generar Reporte Anexo 4.'
				}
		);
	...
	tam_pag:50,
	title:'Anexo',
	ActSave:'../../sis_kactivos_fijos/control/Anexo/insertarAnexo3',
	ActDel:'../../sis_kactivos_fijos/control/Anexo/eliminarAnexo',
	ActList:'../../sis_kactivos_fijos/control/Anexo/listarAnexo3',
	id_store:'id_anexo',
	fields: [
	...
	onButtonReporte4: function() {
		Phx.CP.loadingShow();
		var d = this.maestro;
		console.log('codigo:',d.id_periodo_anexo);

		Ext.Ajax.request({
						url:'../../sis_kactivos_fijos/control/PeriodoAnexo/reporteAnexo4',
						params:{
